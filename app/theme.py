...
def create_filmquant_ml_interface(callbacks=None):
    ...
    if callbacks is None:
        ...
        historical_film_selected_callback = callbacks.get("historical_film_selected_callback")
    ...
    with gr.Blocks(theme=apple_theme, title="FilmQuant ML - Film Revenue Predictor") as filmquant_ml_interface:
        gr.Markdown(
            """
