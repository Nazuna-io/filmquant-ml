...
def predict_button_callback(
    ...
    try:
        ...
        top_factors = pd.DataFrame(
            {
                ...
                "Impact": [
                    f"${budget:.0f}M" if budget else "N/A",
                    "2/3 A-list",
        ...
        raw_input = {"title": title, "prediction": prediction, "budget": budget}
...
if __name__ == "__main__":
    ...
    interface.launch(server_name="0.0.0.0", server_port=8081, show_error=True)
